...
@Service
public class OperatingSystemService extends AbstractServiceImpl<OperatingSystem, String, OperatingSystemRepository>
        implements OperatingSystemServiceInterface {
